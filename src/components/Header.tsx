          ...
          <nav className="hidden md:flex items-center gap-5 lg:gap-7">
            ...
            >
              <button
                ...
                className="inline-flex items-center gap-1 text-sm font-medium text-slate-600 hover:text-navy transition-colors"
                  ...
                  <div className="rounded-xl border border-slate-200 bg-white shadow-lg py-2">
                    {herramientas.map((h) => (
                      <Link
                        key={h.href}
                        href={h.href}
                        className="block px-4 py-2 text-sm text-slate-600 hover:bg-slate-50 hover:text-navy transition-colors"
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-slate-200 bg-white">
          <div className="px-4 py-4 space-y-3">
            ...
            <p className="pt-2 text-xs font-semibold text-slate-400 uppercase tracking-wider">
              Herramientas
            </p>
            {herramientas.map((h) => (
              <Link
                key={h.href}
                href={h.href}
                className="block pl-3 text-sm font-medium text-slate-600 hover:text-navy"
                onClick={() => setMenuOpen(false)}
              >
                {h.label}
              </Link>
